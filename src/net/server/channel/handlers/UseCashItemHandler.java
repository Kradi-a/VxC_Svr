            ...
            if (itemId > 5050000) {
                ...
                switch (APFrom) {
                    ...
                    case 2048: // HP
                        ...
                        int nextHp = Math.max(1, player.getHp() + hplose),
                         nextMaxHp = Math.max(50, player.getMaxHp() + hplose);
                    ...
                    case 8192: // MP
                        ...
                        int nextMp = Math.max(0, player.getMp() + mplose),
                         nextMaxMp = Math.max(5, player.getMaxMp() + mplose);
